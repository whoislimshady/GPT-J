...
def main():
    st.set_page_config(  # Alternate names: setup_page, page, layout
        ...
        page_title="GPT-J 6B",  # String or None. Strings get appended with "• Streamlit".
        page_icon="voiceshop",  # String, anything supported by st.image, or None.
    )
    st.title("Languge model")
    """This app enables you to interact with large language models!"""
